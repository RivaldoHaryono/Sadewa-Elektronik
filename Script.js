...
(function () {
  ...
  function genReply(raw) {
    ...
    if (/bayar|pembayaran|transfer|gopay|ovo|dana|qris|bca|mandiri/.test(q)) return { html: '💳 <b>Metode Bayar:</b><br>🏦 Transfer Bank: BRI<br>📲 QRIS (bisa pakai e-wallet/m-banking apa saja)', chips: ['🛒 Cara Beli', '💡 Lihat Produk'] };
