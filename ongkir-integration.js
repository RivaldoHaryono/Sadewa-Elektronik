...
(function () {
  ...
  // ---- KONFIGURASI ----
  // Project ID sudah diisi (sadewa-2), diambil dari firebaseConfig di firebase-app.js.
  ...
  // BELUM BISA DIISI SEKARANG — baru bisa didapat setelah:
  // 1) Upgrade Firebase ke paket Blaze
  // 2) Deploy Cloud Function cariKota & cekOngkir (proxy ke rajaongkir.com)
  // 3) Panggil cariKota?keyword=Cidahu lalu salin id hasilnya ke sini
  // Target: 11 September. Sebelum itu diisi, fitur ongkir akan gagal dengan jelas
  // (bukan salah kirim data), lihat cekOngkirSekarang().
  const ORIGIN_ID = "BELUM_DIKONFIGURASI";
  ...
  async function cekOngkirSekarang() {
    ...
    if (ORIGIN_ID === "BELUM_DIKONFIGURASI") {
      resultBox.innerHTML = `<div class="ongkir-error">Fitur cek ongkir belum aktif. Silakan isi alamat manual, admin akan konfirmasi ongkir lewat chat.</div>`;
      return;
    }
